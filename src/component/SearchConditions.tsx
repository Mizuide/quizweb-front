...
const SearchConditions: React.FC<prop> = (prop: prop) => {
    ...
    return (
        <div className='SearchConditions'>
            ...
            <Input size="mini" onChange={(e) => setWhereTitle(e.target.value)} action={{"size":"tiny","content":'検索',"icon":'search','onClick':() => prop.setConditions({...prop.conditions, category: category, order: orderConst.orderId.newOrder, title: wheretitle })}} />
